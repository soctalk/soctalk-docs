...
Aktuelle Version: **v0.2.1**: [Release-Seite](https://github.com/soctalk/soctalk/releases/tag/v0.2.1) · [alle Releases](https://github.com/soctalk/soctalk/releases)
...
- [`soctalk-demo-0.2.1.vhd.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhd.xz), Microsoft Azure (feste Größe, 1 MiB ausgerichtet)
- [`soctalk-demo-0.2.1.raw.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.raw.xz), generischer Cloud-Import (GCP, OpenStack), `dd` auf physischen Datenträger
- [`SHA256SUMS.txt`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/SHA256SUMS.txt), Prüfsummen für alle oben genannten Dateien
