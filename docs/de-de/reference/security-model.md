...
- **LLM-Response-Cache.** Ab Tag 1 auf `(tenant_id, prompt_hash)` verschlüsselt. Bei jeglicher Lockerung besteht das Risiko eines mandantenübergreifenden Inhaltslecks; die Testsuite prüft die Zusammensetzung des Schlüssels.
