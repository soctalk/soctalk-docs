...
Als Verzeichnisse unter `charts/soctalk-tenant/charts/` mitgeliefert (vendored), nicht zur Installationszeit abgerufen. `Chart.yaml` listet sie als lokale Abhängigkeiten auf:
