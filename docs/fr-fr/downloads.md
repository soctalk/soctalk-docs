...
Version actuelle : **v0.2.1**: [page de la version](https://github.com/soctalk/soctalk/releases/tag/v0.2.1) · [toutes les versions](https://github.com/soctalk/soctalk/releases)
...
- [`soctalk-demo-0.2.1.vhdx.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhdx.xz), Microsoft Hyper-V (Génération 1)
- [`soctalk-demo-0.2.1.vhd.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhd.xz), Microsoft Azure (taille fixe, aligné sur 1 MiB)
- [`soctalk-demo-0.2.1.raw.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.raw.xz), import cloud générique (GCP, OpenStack), `dd` vers un disque physique
- [`SHA256SUMS.txt`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/SHA256SUMS.txt), sommes de contrôle pour tous les fichiers ci-dessus
