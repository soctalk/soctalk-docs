...
| `just release` | Étiquette + pousse les images + le chart + crée une GitHub Release |
...
| `scripts/inject_test_data.py` | Injecte des charges utiles de test spécifiques — utile pour reproduire un bug signalé par un client |
