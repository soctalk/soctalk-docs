...
Current version: **v0.1.2** — [release page](https://github.com/soctalk/soctalk/releases/tag/v0.1.2) · [all releases](https://github.com/soctalk/soctalk/releases)
...
```bash
curl -L -O https://github.com/soctalk/soctalk/releases/download/v0.1.2/SHA256SUMS.txt
...
```bash
gh workflow run build-packer-images.yml -f version=0.1.2
```
