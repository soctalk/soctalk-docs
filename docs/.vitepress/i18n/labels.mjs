...
export const TR = {
  'pt-br': {
    ...
    item: {
     ...
     'guides/multi-tenant-wazuh-mssp': 'Wazuh multi-tenant para MSSPs', 'guides/ai-triage-wazuh-alerts': 'Triagem de alertas Wazuh com AI', 'guides/wazuh-tenant-onboarding': 'Onboarding de um tenant cliente', 'guides/open-source-soc-stack': 'Stack SOC open source', 'guides/inference-cost-optimization': 'Manter a conta do triage de IA baixa'},
    ui: {
