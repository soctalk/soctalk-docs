...
export const TR = {
  'pt-br': {
    ...
    item: {
      ...
      'os-packages': 'Instalar a partir de um pacote do SO',
      downloads: 'Downloads',
      ...
      'tenant-onboarding': 'Onboarding de tenant',
