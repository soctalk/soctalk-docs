...
当前版本：**v0.2.1** — [发布页面](https://github.com/soctalk/soctalk/releases/tag/v0.2.1) · [所有版本](https://github.com/soctalk/soctalk/releases)
...
- [`soctalk-demo-0.2.1.vhdx.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhdx.xz) — Microsoft Hyper-V（第 1 代）
- [`soctalk-demo-0.2.1.vhd.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhd.xz) — Microsoft Azure（固定大小，1 MiB 对齐）
- [`soctalk-demo-0.2.1.raw.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.raw.xz) — 通用云导入（GCP、OpenStack），可 `dd` 写入物理磁盘
- [`SHA256SUMS.txt`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/SHA256SUMS.txt) — 以上所有文件的校验和
