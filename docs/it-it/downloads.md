...
Versione corrente: **v0.2.1**: [pagina della release](https://github.com/soctalk/soctalk/releases/tag/v0.2.1) · [tutte le release](https://github.com/soctalk/soctalk/releases)
...
- [`soctalk-demo-0.2.1.vhd.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhd.xz), Microsoft Azure (dimensione fissa, allineato a 1 MiB)
- [`soctalk-demo-0.2.1.raw.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.raw.xz), importazione cloud generica (GCP, OpenStack), `dd` su disco fisico
- [`SHA256SUMS.txt`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/SHA256SUMS.txt), checksum per tutti i file elencati sopra
