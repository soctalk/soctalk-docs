...
- **Concorrência de worker que enche o batch** ([#61](https://github.com/soctalk/soctalk/issues/61)). Várias investigações rodam ao mesmo tempo, então múltiplas requisições estão em voo contra o backend e o batch contínuo enche. Esse batch cheio é de onde vêm a maior vazão e o menor custo desta página.
