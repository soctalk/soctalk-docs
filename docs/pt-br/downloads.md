...
Versão atual: **v0.2.1**: [página do release](https://github.com/soctalk/soctalk/releases/tag/v0.2.1) · [todos os releases](https://github.com/soctalk/soctalk/releases)
...
- [`soctalk-demo-0.2.1.vhd.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhd.xz), Microsoft Azure (tamanho fixo, alinhado a 1 MiB)
- [`soctalk-demo-0.2.1.raw.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.raw.xz), importação genérica para nuvem (GCP, OpenStack), `dd` para disco físico
- [`SHA256SUMS.txt`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/SHA256SUMS.txt), checksums de todos os itens acima
