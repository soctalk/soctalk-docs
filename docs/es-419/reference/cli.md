...
| `just release` | Etiqueta + empuja imágenes + chart + crea un Release de GitHub |
...
| `scripts/inject_test_data.py` | Inyecta cargas de prueba específicas: útil al reproducir un bug reportado por un cliente |
