...
Versión actual: **v0.2.1**: [página de la versión](https://github.com/soctalk/soctalk/releases/tag/v0.2.1) · [todas las versiones](https://github.com/soctalk/soctalk/releases)
...
- [`soctalk-demo-0.2.1.vhd.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.vhd.xz), Microsoft Azure (tamaño fijo, alineado a 1 MiB)
- [`soctalk-demo-0.2.1.raw.xz`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/soctalk-demo-0.2.1.raw.xz), importación genérica a la nube (GCP, OpenStack), `dd` a disco físico
- [`SHA256SUMS.txt`](https://github.com/soctalk/soctalk/releases/download/v0.2.1/SHA256SUMS.txt), sumas de verificación para todo lo anterior
