...
Esto produce un `soctalk-demo-0.2.0.vdi` escribible y de tamaño dinámico (unos pocos GB en disco). `VBoxManage` se incluye con VirtualBox; en Windows está en `C:\Program Files\Oracle\VirtualBox\`.
